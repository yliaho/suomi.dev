defmodule SuomidevWeb.UserController do
  ...
  def update(conn, %{"id" => id, "user" => user_params}) do
    ...
    with :ok <- Bodyguard.permit(Accounts, :update_user, conn.assigns.current_user, user),
      ...
      _ ->
        ...
        |> put_flash(
          :error,
          "Sinun pitää olla kirjautunut sisään, jotta voit muokata käyttäjäprofiileja."
        )
  ...
  def delete(conn, %{"id" => id}) do
    ...
    with :ok <- Bodyguard.permit(Accounts, :update_user, conn.assigns.current_user, user),
      ...
      _ ->
        ...
        |> put_flash(
          :error,
          "Sinun pitää olla kirjautunut sisään, jotta voit poistaa käyttäjäprofiileja."
        )
        |> redirect(to: Routes.page_path(conn, :index))
    end
  end
